...
import (
	...
	"dagger/anybadge/internal/querybuilder"
	"dagger/anybadge/internal/telemetry"
)
...
// The `PythonID` scalar type represents an identifier for an object of type Python.
type PythonID string
...
// Retrieve the binding value, as type GoWithSource
func (r *Binding) AsGoWithSource() *GoWithSource {
	q := r.query.Select("asGoWithSource")
...
// Retrieve the binding value, as type Python
func (r *Binding) AsPython() *Python {
	q := r.query.Select("asPython")
...
// Create or update a binding of type GoWithSource in the environment
func (r *Env) WithGoWithSourceInput(name string, value *GoWithSource, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withGoWithSourceInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired GoWithSource output to be assigned in the environment
func (r *Env) WithGoWithSourceOutput(name string, description string) *Env {
	q := r.query.Select("withGoWithSourceOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
// Create or update a binding of type Python in the environment
func (r *Env) WithPythonInput(name string, value *Python, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withPythonInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Python output to be assigned in the environment
func (r *Env) WithPythonOutput(name string, description string) *Env {
	q := r.query.Select("withPythonOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
type Go struct { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L17)
	query *querybuilder.Selection
...
type GoBuildOpts struct {
	...
	// Package to compile.
	//
	Pkg string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L252)
	//
	// Enable data race detection.
	//
	Race bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L257)
	//
	// Arguments to pass on each go tool link invocation.
	//
	Ldflags []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L262)
	//
	// A list of additional build tags to consider satisfied during the build.
	//
	Tags []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L267)
	//
	// Remove all file system paths from the resulting executable.
	//
	Trimpath bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L272)
	//
	// Additional args to pass to the build command.
	//
	RawArgs []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L277)
	//
	// Target platform in "[os]/[platform]/[version]" format (e.g., "darwin/arm64/v7", "windows/amd64", "linux/arm64").
	//
	Platform Platform // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L282)
}

// Build a binary.
func (r *Go) Build(source *Directory, opts ...GoBuildOpts) *File { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L245)
	assertNotNil("source", source)
...
func (r *Go) Container() *Container { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L18)
	q := r.query.Select("container")
...
type GoExecOpts struct {
	...
	//
	Src *Directory // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L195)
	//
	// Target platform in "[os]/[platform]/[version]" format (e.g., "darwin/arm64/v7", "windows/amd64", "linux/arm64").
	//
	Platform Platform // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L200)
}

// Run a Go command.
func (r *Go) Exec(args []string, opts ...GoExecOpts) *Container { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L188)
...
type GoGenerateOpts struct {
	...
	//
	Packages []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L223)
	//
	...
	//
	Run string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L228)
	//
	...
	//
	Skip string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L233)
}

// Run "go generate" command.
//
// Consult "go help generate" for more information.
func (r *Go) Generate(source *Directory, opts ...GoGenerateOpts) *Directory { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L216)
	assertNotNil("source", source)
...
type GoWithBuildCacheOpts struct {
	...
	// Identifier of the directory to use as the cache volume's root.
	//
	Source *Directory // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L168)
	//
	// Sharing mode of the cache volume.
	//
	Sharing CacheSharingMode // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L173)
}

// Mount a cache volume for Go build cache.
func (r *Go) WithBuildCache(cache *CacheVolume, opts ...GoWithBuildCacheOpts) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L162)
	assertNotNil("cache", cache)
...
func (r *Go) WithCgoDisabled() *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L129)
...
func (r *Go) WithCgoEnabled() *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L122)
...
type GoWithEnvVariableOpts struct {
	...
	//
	Expand bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L70)
}

// Set an environment variable.
func (r *Go) WithEnvVariable(name string, value string, opts ...GoWithEnvVariableOpts) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L59)
	q := r.query.Select("withEnvVariable")
	for i := len(opts) - 1; i >= 0; i-- {
		// `expand` optional argument
		if !querybuilder.IsZeroValue(opts[i].Expand) {
...
type GoWithModuleCacheOpts struct {
	...
	// Identifier of the directory to use as the cache volume's root.
	//
	Source *Directory // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L142)
	//
	// Sharing mode of the cache volume.
	//
	Sharing CacheSharingMode // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L147)
}

// Mount a cache volume for Go module cache.
func (r *Go) WithModuleCache(cache *CacheVolume, opts ...GoWithModuleCacheOpts) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L136)
	assertNotNil("cache", cache)
...
func (r *Go) WithPlatform(platform Platform) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L97)
...
func (r *Go) WithServiceBinding(alias string, service *Service) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L84)
	assertNotNil("service", service)
	q := r.query.Select("withServiceBinding")
	q = q.Arg("alias", alias)
	q = q.Arg("service", service)
...
func (r *Go) WithSource(source *Directory) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L296)
	assertNotNil("source", source)
...
type GoWithSource struct { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L306)
	query *querybuilder.Selection
...
type GoWithSourceBuildOpts struct {
	...
	// Package to compile.
	//
	Pkg string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L485)
	//
	// Enable data race detection.
	//
	Race bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L490)
	//
	// Arguments to pass on each go tool link invocation.
	//
	Ldflags []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L495)
	//
	// A list of additional build tags to consider satisfied during the build.
	//
	Tags []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L500)
	//
	// Remove all file system paths from the resulting executable.
	//
	Trimpath bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L505)
	//
	// Additional args to pass to the build command.
	//
	RawArgs []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L510)
	//
	// Target platform in "[os]/[platform]/[version]" format (e.g., "darwin/arm64/v7", "windows/amd64", "linux/arm64").
	//
	Platform Platform // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L515)
}

// Compile the packages into a binary.
func (r *GoWithSource) Build(opts ...GoWithSourceBuildOpts) *File { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L481)
	q := r.query.Select("build")
	for i := len(opts) - 1; i >= 0; i-- {
		// `pkg` optional argument
		if !querybuilder.IsZeroValue(opts[i].Pkg) {
...
func (r *GoWithSource) Container() *Container { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L313)
	q := r.query.Select("container")
...
type GoWithSourceExecOpts struct {
	...
	// Target platform in "[os]/[platform]/[version]" format (e.g., "darwin/arm64/v7", "windows/amd64", "linux/arm64").
	//
	Platform Platform // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L433)
}

// Run a Go command.
func (r *GoWithSource) Exec(args []string, opts ...GoWithSourceExecOpts) *Container { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L426)
	q := r.query.Select("exec")
	for i := len(opts) - 1; i >= 0; i-- {
		// `platform` optional argument
		if !querybuilder.IsZeroValue(opts[i].Platform) {
...
// GoWithSourceGenerateOpts contains options for GoWithSource.Generate
type GoWithSourceGenerateOpts struct {
	//
	// Packages (or files) to run "go generate" on.
	//
	Packages []string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L449)
	//
	// A regular expression to select directives whose full original source text (excluding any trailing spaces and final newline) matches the expression.
	//
	Run string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L454)
	//
	// A regular expression to suppress directives whose full original source text (excluding any trailing spaces and final newline) matches the expression.
	//
	Skip string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L459)
}

// Run "go generate" command.
//
// Consult "go help generate" for more information.
func (r *GoWithSource) Generate(opts ...GoWithSourceGenerateOpts) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L445)
	q := r.query.Select("generate")
	for i := len(opts) - 1; i >= 0; i-- {
		// `packages` optional argument
		if !querybuilder.IsZeroValue(opts[i].Packages) {
...
func (r *GoWithSource) Source() *Directory { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L307)
	q := r.query.Select("source")
...
type GoWithSourceWithBuildCacheOpts struct {
	...
	// Identifier of the directory to use as the cache volume's root.
	//
	Source *Directory // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L401)
	//
	// Sharing mode of the cache volume.
	//
	Sharing CacheSharingMode // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L406)
}

// Mount a cache volume for Go build cache.
func (r *GoWithSource) WithBuildCache(cache *CacheVolume, opts ...GoWithSourceWithBuildCacheOpts) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L395)
	assertNotNil("cache", cache)
	q := r.query.Select("withBuildCache")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
...
// Set CGO_ENABLED environment variable to 0.
func (r *GoWithSource) WithCgoDisabled() *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L369)
	q := r.query.Select("withCgoDisabled")
...
// Set CGO_ENABLED environment variable to 1.
func (r *GoWithSource) WithCgoEnabled() *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L362)
	q := r.query.Select("withCgoEnabled")
...
type GoWithSourceWithEnvVariableOpts struct {
	...
	// variables defined in the container (e.g., "/opt/bin:$PATH").
	//
	Expand bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L331)
}

// Set an environment variable.
func (r *GoWithSource) WithEnvVariable(name string, value string, opts ...GoWithSourceWithEnvVariableOpts) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L320)
	q := r.query.Select("withEnvVariable")
	for i := len(opts) - 1; i >= 0; i-- {
		// `expand` optional argument
		if !querybuilder.IsZeroValue(opts[i].Expand) {
...
// Run a Go command.
func (r *GoWithSource) WithExec(args []string) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L414)
	q := r.query.Select("withExec")
	q = q.Arg("args", args)
...
type GoWithSourceWithModuleCacheOpts struct {
	...
	// Identifier of the directory to use as the cache volume's root.
	//
	Source *Directory // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L382)
	//
	// Sharing mode of the cache volume.
	//
	Sharing CacheSharingMode // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L387)
}

// Mount a cache volume for Go module cache.
func (r *GoWithSource) WithModuleCache(cache *CacheVolume, opts ...GoWithSourceWithModuleCacheOpts) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L376)
	assertNotNil("cache", cache)
	q := r.query.Select("withModuleCache")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
...
// Set GOOS, GOARCH and GOARM environment variables.
func (r *GoWithSource) WithPlatform(platform Platform) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L352)
	q := r.query.Select("withPlatform")
	q = q.Arg("platform", platform)
...
// Establish a runtime dependency on a service.
func (r *GoWithSource) WithServiceBinding(alias string, service *Service) *GoWithSource { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L339)
	assertNotNil("service", service)
	q := r.query.Select("withServiceBinding")
	q = q.Arg("alias", alias)
	q = q.Arg("service", service)
...
type Python struct { // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L12)
	query *querybuilder.Selection

	id *PythonID
}
type WithPythonFunc func(r *Python) *Python

// With calls the provided function with current Python.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Python) With(f WithPythonFunc) *Python {
	return f(r)
}

func (r *Python) WithGraphQLQuery(q *querybuilder.Selection) *Python {
	return &Python{
		query: q,
	}
}

func (r *Python) Container() *Container { // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L13)
	q := r.query.Select("container")
...
// A unique identifier for this Python.
func (r *Python) ID(ctx context.Context) (PythonID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response PythonID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Python) XXX_GraphQLType() string {
	return "Python"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Python) XXX_GraphQLIDType() string {
	return "PythonID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Python) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Python) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Python) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadPythonFromID(PythonID(id))
	return nil
}

// PythonWithPipCacheOpts contains options for Python.WithPipCache
type PythonWithPipCacheOpts struct {
	//
	// Identifier of the directory to use as the cache volume's root.
	//
	Source *Directory // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L45)
	//
	// Sharing mode of the cache volume.
	//
	Sharing CacheSharingMode // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L50)
}

// Mount a cache volume for Pip cache.
func (r *Python) WithPipCache(cache *CacheVolume, opts ...PythonWithPipCacheOpts) *Python { // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L39)
	assertNotNil("cache", cache)
	q := r.query.Select("withPipCache")
	for i := len(opts) - 1; i >= 0; i-- {
		// `source` optional argument
		if !querybuilder.IsZeroValue(opts[i].Source) {
			q = q.Arg("source", opts[i].Source)
...
// Mount a source directory.
func (r *Python) WithSource(source *Directory) *Python { // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L59)
	assertNotNil("source", source)
	q := r.query.Select("withSource")
	q = q.Arg("source", source)
...
type GoOpts struct {
	...
	//
	Version string // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L25)
	//
	// Custom container to use as a base container.
	//
	Container *Container // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L30)
	//
	// Disable mounting cache volumes.
	//
	DisableCache bool // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L35)
}

func (r *Client) Go(opts ...GoOpts) *Go { // go (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/go/main.go#L21)
	q := r.query.Select("go")
	for i := len(opts) - 1; i >= 0; i-- {
...
// Load a Python from its ID.
func (r *Client) LoadPythonFromID(id PythonID) *Python {
	q := r.query.Select("loadPythonFromID")
	q = q.Arg("id", id)
...
// PythonOpts contains options for Client.Python
type PythonOpts struct {
	//
	// Version (image tag) to use from the official image repository as a base container.
	//
	Version string // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L20)
	//
	// Custom container to use as a base container.
	//
	Container *Container // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L25)
}

func (r *Client) Python(opts ...PythonOpts) *Python { // python (https://github.com/sagikazarmark/daggerverse/tree/6133ad18e131b891d4723b8e25d69f5de077b472/python/main.go#L16)
	q := r.query.Select("python")
	for i := len(opts) - 1; i >= 0; i-- {
		// `version` optional argument
		if !querybuilder.IsZeroValue(opts[i].Version) {
			q = q.Arg("version", opts[i].Version)
