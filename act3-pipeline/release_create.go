...
func (r *Release) WithRegistryAuth(
	...
	r.pipeline.RegistryConfig = r.pipeline.RegistryConfig.WithRegistryAuth(address, username, secret)
	return r
}
...
func (r *Release) WithoutRegistryAuth(
	...
	r.pipeline.RegistryConfig = r.pipeline.RegistryConfig.WithoutRegistryAuth(address)
	return r
}
...
func (r *Release) orasCtr() *dagger.Container {
	...
	return dag.Wolfi().
		...
		WithMountedSecret("/root/.docker/config.json", r.pipeline.RegistryConfig.Secret())
}
